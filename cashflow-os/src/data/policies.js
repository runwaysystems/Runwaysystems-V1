  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { h: 'Cookie and storage consent', p: 'Essential storefront storage (your cart, theme, accent palette, intro preference, and sign-in session) stays active without consent because it is required for the site to work, as does anonymous first-party page counting. Optional third-party content, such as the Trustpilot reviews widget, only loads after you accept it in the consent banner. You can reopen the banner anytime from the Cookie preferences link in the footer.' },
