  ...
  sections: [
    {
      ...
      blocks: [
        ...
        { h: 'Coming-soon products and launch lists', p: 'A coming-soon product page is an informational preview, not an offer to sell or a reservation. A launch-list request asks us to send that product\'s availability notice; it does not create a contract, reserve a price, or guarantee a release date. You may unsubscribe at any time.' },
    ...
    },
    {
      ...
      blocks: [
        ...
        { h: 'Brevo, launch lists, and marketing email', p: 'Brevo receives the email address, name when available, subject, and message content needed to send product delivery, review-request, requested launch-notification, and optional marketing email. A coming-soon launch-list request is used to send the requested product-live notice. General product marketing is separate and is sent only when you actively opt in through a launch form or your account preferences. Every marketing or launch message includes a one-click unsubscribe link. The private Google Sheets copy link is delivered after verified payment and can also be requested from your authenticated account library. Approximately 72 hours after a verified purchase, every buyer receives the same neutral invitation to leave an honest Trustpilot review or send private feedback. Delivery attempts and status are recorded so failed messages can be retried.' },
